...
//   if (!fn) {
//     return asserter(title, promise);
//   }
//   return promise;
// };

// function asserter(title, promise) {
//   var o = {};
//   Object.keys(assert).forEach(function(key) {
//     o[key] = function(actual, expected) {
//       return promise
//       .then(function() {
//         assert[key].apply(assert[key], [actual, expected, title]);
//       })
//       .catch(function(err) {
//         console.log('%s %s',logSymbols.error, title);
//       })
//     }
//   })
//   return o;
